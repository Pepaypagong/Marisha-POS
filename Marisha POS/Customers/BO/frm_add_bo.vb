Public Class frm_add_bo
    ...
    Private Sub cmd_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_save.Click
        ...
        ElseIf dgv_purchase_list.Rows.Count < 1 Then
            ...
            cmd_select_item.Focus()
        Else
            If MsgBox(" B.O. INFORMATION " & vbCrLf & "" & vbCrLf & _
                          " Date : " + dtp_date.Text & vbCrLf & "" + _
                          " B.O. No : " + lbl_trans_no.Text & vbCrLf & "" + _
                          " Receipt No. : " + txt_ref_no.Text & vbCrLf & "" & vbCrLf & "" + _
                          " Remarks : " + txt_remarks.Text & vbCrLf & "" & vbCrLf & "" + _
                          " Grand Total : P " + lbl_grand_total.Text & vbCrLf & "", MsgBoxStyle.Question + MsgBoxStyle.YesNo, " Are You Sure You Want To Commit This B.O. Transaction?") = MsgBoxResult.Yes Then
                bo_query.insert_sales_return_trans()
                bo_query.insert_sales_return_items()
                bo_query.load_trans_filter()
                MsgBox(" B.O. Successfully Recorded!", MsgBoxStyle.Information, " Transaction Saved")
                Me.Close()
            End If
        End If
    End Sub
