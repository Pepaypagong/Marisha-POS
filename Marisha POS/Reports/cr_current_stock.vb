...
Public Class cr_current_stock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Marisha_POS.cr_current_stock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_current_stock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_current_stock = New cr_current_stock()
        rpt.Site = Me.Site
        Return rpt
    End Function
