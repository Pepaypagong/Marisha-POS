...
Public Class cr_ar_payments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Marisha_POS.cr_ar_payments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_ar_payments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_ar_payments = New cr_ar_payments()
        rpt.Site = Me.Site
        Return rpt
    End Function
