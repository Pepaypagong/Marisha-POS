...
Public Class cr_daily_remit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Marisha_POS.cr_daily_remit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_daily_remit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_daily_remit = New cr_daily_remit()
        rpt.Site = Me.Site
        Return rpt
    End Function
