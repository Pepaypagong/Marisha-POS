Public Class frm_addstock
    ...
    Private Sub frm_addstock_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inventory_query.get_purchase_trans_no()
    ...
    Private Sub cmd_select_supplier_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_select_supplier.Click
        frm_select_supplier.add_stock = True
        frm_select_supplier.return_stock = False
    ...
    Private Sub cmd_select_item_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_select_item.Click
        frm_select_item.add_stock = True
    ...
    Private Sub txt_qty_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_qty.TextChanged, txt_discount.TextChanged
        'lagyan ng is numeric'
        If Not IsNumeric(txt_qty.Text) Then
            txt_qty.Text = "0"
        ElseIf Not IsNumeric(txt_discount.Text) Then
            txt_discount.Text = "0"
        Else
    ...
    Private Sub cmd_add_to_list_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_add_to_list.Click
        ...
        ElseIf CDec(txt_qty.Text) <= 0 Then
            ...
            txt_qty.Focus()
        ElseIf CDec(lbl_total_after_disc.Text) < 0 Then
            MsgBox(" Please Check Your Input! Negative Entries Are Not Allowed", MsgBoxStyle.Critical, " Invalid Entry")
            txt_discount.Focus()
        Else
    ...
    Public Sub add_to_list()
        dgv_purchase_list.Rows.Add(New Object() _
                             {lbl_item_no.Text, lbl_barcode.Text, _
                              ...
                              txt_discount.Text, lbl_total_after_disc.Text, lbl_beginning.Text, CDec(lbl_ending.Text) + CDec(txt_qty.Text), _
    ...
    Sub looptotal()
        ...
        For index As Integer = 0 To dgv_purchase_list.RowCount - 1
            ...
            total_disc += Convert.ToDecimal(dgv_purchase_list.Rows(index).Cells(9).Value)
            grand_total += Convert.ToDecimal(dgv_purchase_list.Rows(index).Cells(10).Value)
        ...
        lbl_total_discount.Text = total_disc
    ...
    Private Sub cmd_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_save.Click
        ...
        ElseIf dgv_purchase_list.Rows.Count < 1 Then
            ...
            cmd_select_item.Focus()
        Else
            If MsgBox(" PURCHASE TRANSACTION INFORMATION " & vbCrLf & "" & vbCrLf & _
                          " Transaction Date : " + dtp_date.Text & vbCrLf & "" + _
                          " Transaction No : " + lbl_trans_no.Text & vbCrLf & "" + _
                          " Supplier No. : " + lbl_supplier_no.Text & vbCrLf & "" + _
                          " Supplier Name : " + lbl_supplier_name.Text & vbCrLf & "" + _
                          " Supplier Refrerence No. : " + txt_ref_no.Text & vbCrLf & "" & vbCrLf & "" + _
                          " Sub Total : P " + lbl_sub_total_grand.Text & vbCrLf & "" + _
                          " Total Discount : P " + lbl_total_discount.Text & vbCrLf & "" + _
                          " Grand Total : P " + lbl_grand_total.Text & vbCrLf & "", MsgBoxStyle.Question + MsgBoxStyle.YesNo, " Are You Sure You Want To Commit Transaction?") = MsgBoxResult.Yes Then
                inventory_query.insert_purchase_trans()
                inventory_query.insert_purchase_items()
                'inventory_query.insert_begin_end_purchase() 'begin end inventory (items)'
                For Each row As DataGridViewRow In me.dgv_purchase_list.Rows
                    item_flow_service.InsertItemFlow(row.Cells(0).Value, Me.dtp_date.Value(),
                                                  "PURCHASE", row.Cells(6).Value, 0, 0, row.Cells(8).Value)
                Next

                'inventory_query.insert_beg_inv_price() 'begin inv price 
                inventory_query.add_stock_qty()
                inventory_query.load_item()
                MsgBox(" Purchase Transaction Successfully Saved!", MsgBoxStyle.Information, " Transaction Saved")
                Me.Close()
            End If
        End If
    End Sub
